...
public class RecetasObjectSet {
  ...
  public Receta crearRecetas(final Usuario usuario) {
    Receta _xblockexpression = null;
    {
      ...
      RecetaBuilder _setearCalorias = _agregarIngrediente_4.setearCalorias(150);
      ...
      RecetaBuilder _agregarIngrediente_5 = _nombreDelPlato_1.agregarIngrediente(this.harina);
      RecetaBuilder _agregarIngrediente_6 = _agregarIngrediente_5.agregarIngrediente(this.huevo);
      RecetaBuilder _agregarIngrediente_7 = _agregarIngrediente_6.agregarIngrediente(this.panRallado);
      RecetaBuilder _agregarIngrediente_8 = _agregarIngrediente_7.agregarIngrediente(this.carne);
      RecetaBuilder _agregarIngrediente_9 = _agregarIngrediente_8.agregarIngrediente(this.queso);
      RecetaBuilder _agregarIngrediente_10 = _agregarIngrediente_9.agregarIngrediente(this.salsaDeTomate);
      RecetaBuilder _setearCalorias_1 = _agregarIngrediente_10.setearCalorias(8000);
      ...
      RecetaBuilder _setearPreparacion_1 = _setearDificultad_1.setearPreparacion("Pasar la carne por huevo, harina y pan rallado. Freir con el aceite por 10 minutos. Luego colocarle la salsa de tomate, el queso y  calentar");
      _setearPreparacion_1.build();
      ...
      RecetaBuilder _agregarIngrediente_11 = _nombreDelPlato_2.agregarIngrediente(this.verdura);
      RecetaBuilder _agregarIngrediente_12 = _agregarIngrediente_11.agregarIngrediente(this.sal);
      RecetaBuilder _setearCalorias_2 = _agregarIngrediente_12.setearCalorias(200);
      ...
      RecetaBuilder _agregarIngrediente_13 = _nombreDelPlato_3.agregarIngrediente(this.prepizza);
      RecetaBuilder _agregarIngrediente_14 = _agregarIngrediente_13.agregarIngrediente(this.salsaDeTomate);
      RecetaBuilder _agregarIngrediente_15 = _agregarIngrediente_14.agregarIngrediente(this.oregano);
      RecetaBuilder _agregarIngrediente_16 = _agregarIngrediente_15.agregarIngrediente(this.queso);
      RecetaBuilder _setearTemporadas_3 = _agregarIngrediente_16.setearTemporadas("Todo el año");
      ...
      RecetaBuilder _setearPreparacion_3 = _setearCalorias_3.setearPreparacion("Cocinar la prepizza en el horno. Agregar el queso y volver a cocinar. Agregar oregano a gusto");
      _setearPreparacion_3.build();
      ...
      RecetaBuilder _agregarIngrediente_17 = _nombreDelPlato_4.agregarIngrediente(this.prepizza);
      RecetaBuilder _agregarIngrediente_18 = _agregarIngrediente_17.agregarIngrediente(this.salsaDeTomate);
      RecetaBuilder _agregarIngrediente_19 = _agregarIngrediente_18.agregarIngrediente(this.queso);
      RecetaBuilder _agregarIngrediente_20 = _agregarIngrediente_19.agregarIngrediente(this.salsaBlanca);
      RecetaBuilder _agregarIngrediente_21 = _agregarIngrediente_20.agregarIngrediente(this.verdura);
      RecetaBuilder _setearTemporadas_4 = _agregarIngrediente_21.setearTemporadas("Todo el año");
      ...
      RecetaBuilder _setearPreparacion_4 = _setearDificultad_4.setearPreparacion("Cocinar la prepizza en el horno. Agregar el queso y volver a cocinar. Agregar la salsa blanca y la verdura");
      _setearPreparacion_4.build();
      ...
      RecetaBuilder _agregarIngrediente_22 = _nombreDelPlato_5.agregarIngrediente(this.lomo);
      RecetaBuilder _setearCalorias_5 = _agregarIngrediente_22.setearCalorias(300);
      ...
      RecetaBuilder _setearPreparacion_5 = _setearDificultad_5.setearPreparacion("Colocar el lomo en la plancha y cocinar. Esperar a que este listo y darlo vuelta. Seguir cocinando");
      _setearPreparacion_5.build();
      ...
      RecetaBuilder _nombreDelPlato_6 = _tipoDeReceta_6.nombreDelPlato("Hummus de garbanzo");
      RecetaBuilder _agregarIngrediente_23 = _nombreDelPlato_6.agregarIngrediente(this.garbanzos);
      RecetaBuilder _agregarIngrediente_24 = _agregarIngrediente_23.agregarIngrediente(this.limon);
      RecetaBuilder _agregarIngrediente_25 = _agregarIngrediente_24.agregarIngrediente(this.ajo);
      RecetaBuilder _setearCalorias_6 = _agregarIngrediente_25.setearCalorias(600);
      RecetaBuilder _setearPreparacion_6 = _setearCalorias_6.setearPreparacion("No tengo ni ganas de hacer una descripcion sobre el hummus de garbanzo porque debe ser horrible");
      _xblockexpression = _setearPreparacion_6.build();
    }
